...
Output/Result: System must generate a result of over 0.7 in F-measure that ERisk must compare
					
How test will be performed: After generating a result from the ERisk servers, the results will be automatically compared with the correct result about who is a pathological gamblers. The criteria includes an F-measure score from 0 to 1 that will be determined by ERisk
